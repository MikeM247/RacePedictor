...
export default defineConfig({
  ...
  outputDir: path.join(e2eRoot, "home-local-test-results"),
  reporter: [["list"], ["json", { outputFile: path.join(e2eRoot, "results", "home-local.json") }]],
  ...
  webServer: {
    ...
    env: {
      ...
      RACEPREDICTOR_NEXT_DIST_DIR: `.next-e2e-home-local-${process.env.RACEPREDICTOR_E2E_RUN_ID}`,
